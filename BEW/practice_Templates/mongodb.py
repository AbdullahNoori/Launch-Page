...
def show_all_songs():
    ...
    # all songs
    all_songs = 'songs_list.collection.find('was_published_recenty': True)']
...
def show_classical_songs():
    ...
    classical_songs ['songs.collection.find("genre": "Classical")
...
def show_song(song_id):
    ...
    # `ObjectId`.
    song = "songs.collection.find_one({"_id": ObjectId(song_id)})
